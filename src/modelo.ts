...
const crearContenerdor = (cartas: Carta[]) => {
  ...
  cartas.forEach((_, indice) => {
    ...
    listaCartas.innerHTML=`  <div class="frente">
    <img class="imagen-carta" id="img-${indice}" src='${cartas[indice].imagen}' />
  </div>
  <div class="dorso"><img class="imagen-dorso" id="img-dorso-${indice}" src='./src/img/digimon.png' /></div>
`;
